...
export const TEMPLATES: TemplateConfig[] = [
  {
    ...
    action: { type: 'OpenUrl', url: '', browser: undefined, post_shortcuts: [], shortcut_delay_secs: 1 },
  ...
  },
  {
    ...
    action: { type: 'OpenFile', path: '', app: undefined, post_shortcuts: [], shortcut_delay_secs: 1 },
    schedule: { type: 'Cron', expression: '0 9 * * *' },
  },
  {
    name: 'OpenApp',
    ...
    action: { type: 'OpenApp', app_path: '', post_shortcuts: [], shortcut_delay_secs: 1 },
    schedule: { type: 'Cron', expression: '0 9 * * *' },
  },
  {
    name: 'RunCommand',
